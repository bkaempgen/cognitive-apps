...
public class Pipeline {
	...
	public static void startPipeline() {
		...
		// given input
		String t1Image = "/data/SFB/Input-Images/T1.nrrd";
		String atlasImage = "/data/SFB/Input-Images/atlasImage.mha";
		String atlasMask = "/data/SFB/Input-Images/atlasMask.mha";

		// user respectively client defined output paths
		String castAtlasOutputImageFile = "/data/SFB/pipeline/atlasImage.nrrd";
		String castAtlasOutputMaskFile = "/data/SFB/pipeline/atlasMask.nrrd";

		String striptsOutputMaskFile = "/data/SFB/pipeline/stripped_t1_mask.nrrd";
		String striptsOutputImageFile = "/data/SFB/pipeline/stripped_t1_image.nrrd";

		String meanfreeOutputImageFile = "/data/SFB/pipeline/meanfree_t1_normalized_image.nrrd";

		// Service URIs
		String castURI = "http://141.52.218.34:8080/Prototyp/SFBServletCast#i";
		String striptsURI = "http://141.52.218.34:8080/Prototyp/SFBServletStripTs#i";
		String meanfreeURI = "http://141.52.218.34:8080/Prototyp/SFBServletMeanFree#i";
