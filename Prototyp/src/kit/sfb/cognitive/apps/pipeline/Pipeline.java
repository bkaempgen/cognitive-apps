...
public class Pipeline {
	...
	public static void main(String[] args) {
		...
		//Use Case: needed: brain segmentation and normalization of a given t1 scan.
		...
		String requestXML1 =  "<rdf:RDF xmlns:lapis=\"http://localhost:8080/Prototyp/Ontology/Lapis#\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:cast=\"http://localhost:8080/Prototyp/Cast/Ontology#\">"
							...
							+ "<cast:hasInputImage>"+atlasImage+"</cast:hasInputImage>"
							+ "<cast:hasOutputImagePath>"+castAtlasOutputImageFile+"</cast:hasOutputImagePath>"
		...
		String requestXML2 =  "<rdf:RDF xmlns:lapis=\"http://localhost:8080/Prototyp/Ontology/Lapis#\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:cast=\"http://localhost:8080/Prototyp/Cast/Ontology#\">"
							...
							+ "<rdf:type rdf:resource=\"http://localhost:8080/Prototyp/Ontology/Lapis#Request\"/>"
							+ "<cast:hasInputImage>"+atlasMask+"</cast:hasInputImage>"
							+ "<cast:hasOutputImagePath>"+castAtlasOutputMaskFile+"</cast:hasOutputImagePath>"
							+ "</rdf:Description></rdf:RDF>";
		
		//brain segmentation of T1 Image using atlasImage.nrrd and atlasMask.nrrd
		String requestXML3 =  "<rdf:RDF xmlns:lapis=\"http://localhost:8080/Prototyp/Ontology/Lapis#\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:stripts=\"http://localhost:8080/Prototyp/StripTs/Ontology#\">"
							...
							+ "<rdf:type rdf:resource=\"http://localhost:8080/Prototyp/Ontology/Lapis#Request\"/>"
							+ "<stripts:hasInputBrainAtlasImage>"+castAtlasOutputImageFile+"</stripts:hasInputBrainAtlasImage>"
							+ "<stripts:hasInputBrainAtlasMask>"+castAtlasOutputMaskFile+"</stripts:hasInputBrainAtlasMask>"
							+ "<stripts:hasInputImage>"+t1Image+"</stripts:hasInputImage>"
							+ "<stripts:hasOutputMaskPath>"+striptsOutputMaskFile+"</stripts:hasOutputMaskPath>"
							+ "<stripts:hasOutputImagePath>"+striptsOutputImageFile+"</stripts:hasOutputImagePath>"
							+ "</rdf:Description></rdf:RDF>";
		...
		String requestXML4 =  "<rdf:RDF xmlns:lapis=\"http://localhost:8080/Prototyp/Ontology/Lapis#\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:meanfree=\"http://localhost:8080/Prototyp/MeanFree/Ontology#\">"
							...
							+ "<rdf:type rdf:resource=\"http://localhost:8080/Prototyp/Ontology/Lapis#Request\"/>"
							+ "<meanfree:hasInputImage>"+striptsOutputImageFile+"</meanfree:hasInputImage>"
							+ "<meanfree:hasInputMaskImage>"+striptsOutputMaskFile+"</meanfree:hasInputMaskImage>"
							+ "<meanfree:hasOutputImagePath>"+meanfreeOutputImageFile+"</meanfree:hasOutputImagePath>"
							+ "</rdf:Description></rdf:RDF>";
