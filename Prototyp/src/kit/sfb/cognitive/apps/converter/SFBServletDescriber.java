...
public class SFBServletDescriber extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		writer.println("<rdf:Description rdf:about=\"" + host + "Prototyp/SFBServletDescriber#i\">");
		...
		writer.println("<lapis:hasExampleRequest>" + host + "Prototyp/Describer/Input_Example.xml</lapis:hasExampleRequest>");
		writer.println("<lapis:hasExampleResponse>" + host + "Prototyp/Describer/Output_Example.html</lapis:hasExampleResponse>");
	...
	protected void doPost(HttpServletRequest request,
		...
		// Stuff for XSLT
		File xsltFile = new File(Helper.getProperties("lapis_xslt"));
