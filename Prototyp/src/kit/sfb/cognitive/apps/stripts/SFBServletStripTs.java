...
public class SFBServletStripTs extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println("<lapis:hasExampleRequest>http://141.52.218.34:8080/Prototyp/StripTs/RDF_Input_Example.xml</lapis:hasExampleRequest>");
		writer.println("<lapis:hasExampleResponse>http://141.52.218.34:8080/Prototyp/StripTs/RDF_Output_Example.xml</lapis:hasExampleResponse>");
